...
public class FormationControllerDupe : MonoBehaviour {
    ...
    public int maxSwarm = 3;

    private LevelManagerDupe levelManager;
    private int numSwarm;
	...
	void Update () {
		...
		if (AllMembersDead ()) {
            if (numSwarm == maxSwarm)
            {
                levelManager = new LevelManagerDupe();
